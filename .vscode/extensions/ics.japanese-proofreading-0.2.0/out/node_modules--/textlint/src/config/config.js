...
class Config {
    ...
    static initWithAutoLoading(options = {}) {
        ...
        // Create resolver
        const moduleResolver = new textlint_module_resolver_1.TextLintModuleResolver(this, rulesBaseDirectory);
        // => ConfigFile
        ...
        const configRulesObject = separate_by_config_option_1.separateAvailableOrDisable(configFileRaw.rules);
        const configFilterRulesObject = separate_by_config_option_1.separateAvailableOrDisable(configFileRaw.filters);
    ...
    constructor(options = {}) {
        ...
        const configConstructor = this.constructor;
