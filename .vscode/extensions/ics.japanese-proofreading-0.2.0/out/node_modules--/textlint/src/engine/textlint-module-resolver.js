 ...
 * @returns {string}
 */
exports.createFullPackageName = (prefix, name) => {
    if (name.charAt(0) === "@") {
...
class TextLintModuleResolver {
    ...
    resolveRulePackageName(packageName) {
        ...
        const fullPackageName = exports.createFullPackageName(PREFIX, packageName);
...
`);
    ...
    resolvePresetPackageName(packageName) {
        ...
        const packageNameWithoutPreset = packageName
            .replace(/^preset-/, "")
            .replace(/^@([^/]+)\/preset-(.*)$/, `@$1/$2`);
        const fullPackageName = exports.createFullPackageName(PREFIX, packageNameWithoutPreset);
